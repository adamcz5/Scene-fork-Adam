...
final class AppSwitcherHUDWindowController {
    ...
    func show(candidates: [String], selectedIndex: Int) {
        let panel: NSPanel
        ...
        let host = NSHostingController(rootView: AppSwitcherHUDView(candidates: candidates, selectedIndex: selectedIndex))
